...
import BillPrint from "./billprintReport/billprinReport";
        ...
        <div className="row">
          ...
          <div>
            ...
            <div style={{ display: "none" }}>
              {" "}
              <BillPrint  store={this.props.storedata}  data= {this.state.sales}ref={el => (this.componentRef = el)} />
            </div>
          </div>
        </div>
...
export default connect(store => {
  return {
    ...
    companyReducers: store.companyReducers,
