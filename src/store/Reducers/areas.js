...
export default (state = initialData, action) => {
  ...
  switch (action.type) {
    ...
    case "AREAS_CREATED":
      newState.areas = [...newState.areas, ...action.payload];

      break;
    case "AREAS_LOADED":
      Object.assign({}, newState, {
        areas: (newState.areas = action.payload)
      });
      break;
  ...
  newState.code = utlities.getID("A", "code", newState.areas);
